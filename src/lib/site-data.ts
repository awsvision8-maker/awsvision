...
export const FOOTER_LINKS = {
  ...
  company: [
    ...
    { label: "Plano", href: "/serving-texas/plano" },
    ...
    { label: "El Paso", href: "/serving-texas/el-paso" },
    { label: "Serving the U.S.", href: "/serving-united-states" },
    { label: "California", href: "/serving-united-states/california" },
    { label: "Florida", href: "/serving-united-states/florida" },
    { label: "New York", href: "/serving-united-states/new-york" },
...
export const RATES_DATA = {
  savings: [
    {
      product: "AWS Vision Advantage Savings",
      min: "$100",
      max: "No max",
      rate: "Up to bank APY · Discuss on call",
      apy: "Discuss on call",
    },
    {
      product: "Advantage Savings (Preferred Rewards)",
      min: "$100",
      max: "No max",
      rate: "Up to relationship APY · Discuss on call",
      apy: "Discuss on call",
    },
    {
      product: "Investment Savings — Starter Tier",
      min: "$1,000",
      max: "$9,999",
      rate: "Up to program rate · Discuss on call",
      apy: "Discuss on call",
    },
    {
      product: "Investment Savings — Growth Tier",
      min: "$10,000",
      max: "$99,999",
      rate: "Up to program rate · Discuss on call",
      apy: "Discuss on call",
    ...
    {
      product: "Investment Savings — Elite Tier",
      min: "$100,000",
      max: "$249,999+",
      rate: "Up to program rate · Discuss on call",
      apy: "Discuss on call",
