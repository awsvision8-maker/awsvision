...
| Date | Target | Type | Status | Notes / live URL |
|------|--------|------|--------|------------------|
| 2026-09-22 | Dallas Regional Chamber — `memberinfo@dallaschamber.org` | directory | **sent** | From `abdulwahibshera@gmail.com`. Subject: Listing request - AWS Vision Financial (online investment services, Texas). Links: awsvision.com, /serving-texas, /investment-management. Gmail confirmed “Message sent”. No fake address. Template #1. |
| 2026-09-23 | Greater Houston Partnership — `membership@houston.org` | directory | **sent** | From `abdulwahibshera@gmail.com`. Subject: Listing request — AWS Vision Financial (online investment services, Texas). Links: awsvision.com, /serving-texas/houston, /investment-management. Gmail “Message sent”. Template #1. |
